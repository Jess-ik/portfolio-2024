...
const Services = ({ slice }: ServicesProps): JSX.Element => {
    ...
    <section data-slice-type={slice.slice_type} data-slice-variation={slice.variation}>  
			{slice.primary && (
				<div className={clsx("w-screen flex flex-col pb-32 px-32", slice.variation === "right" && "items-end text-right")}>
					...
					<ul className="flex gap-6 uppercase">
						{Array.isArray(slice.primary.tools) &&
							slice.primary.tools.map((tool, index) => (
								<li key={index}>
